function createPetElement(pet) {
  ...
  petElement.innerHTML = `
      ...
      <div class="pet-item__mod-buttons">
        <button class="button is-responsive is-info is-inverted" onclick="editPetClickHandler(this)">Editar</button>
        <button class="button is-responsive is-danger" onclick="removePetClickHandler(this)">Deletar</button>
      </div>`;
